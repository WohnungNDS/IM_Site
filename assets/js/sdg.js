...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, decimalSeparator) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"maps","label":"indicator.map","min_zoom":0,"max_zoom":20,"staticBorders":false},{"subfolder":"worldmap","label":"indicator.map","min_zoom":0,"max_zoom":6,"staticBorders":false}],
      precision: precision,
