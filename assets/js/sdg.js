...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, decimalSeparator) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"minZoom":5,"colorRange":"chroma.brewer.OrRd","tileURL":"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png","tileOptions":{"id":"mapbox.light","accessToken":"pk.eyJ1IjoiY2hyaXN0b3BoNDcxMSIsImEiOiJjanp1cjdpbzQwMTFwM29tdzJ2ZTh3Ymo4In0.C7_7e3AFcMaF_QBg6MaT0Q","attribution":"<a href=\"https://www.mapbox.com\">Mapbox</a> | <a href=\"http://www.bkg.bund.de\">© GeoBasis-DE / BKG | <a href=\"https://www.openstreetmap.org/copyright\">&copy; OpenStreetMap</a>"}},
      mapLayers: [{"subfolder":"maps","min_zoom":6,"max_zoom":9,"staticBorders":false,"label":"Niedersachsen"}],
      precision: precision,
