...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, decimalSeparator) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"maps","label":"indicator.map","min_zoom":6,"max_zoom":10,"staticBorders":false},{"subfolder":"worldmap","label":"indicator.map","min_zoom":1,"max_zoom":6,"staticBorders":false}],
      precision: precision,
